...
> **Warning** | As of 0.4.0, the minimum supported Rust version will be 1.70.0 by default! This can be circumvented by using the `once_cell` feature flag, which will lower the minimum supported version to 1.64.0.
